...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-languageAdvisors">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($advisors as $key => $advisor)
                        <tr data-entry-id="{{ $advisor->id }}">
                            ...
                            <td>
                                <span style="display:none">{{ $advisor->availability ?? '' }}</span>
                            ...
                            <td>
                                @foreach($advisor->languages as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-languageAdvisors:not(.ajaxTable)').DataTable({ buttons: dtButtons })
