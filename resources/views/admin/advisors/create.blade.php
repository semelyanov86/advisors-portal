...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.advisor.title_singular') }}
    </div>
        ...
        <form method="POST" action="{{ route("admin.advisors.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('availability') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="availability" id="availability" value="1" {{ old('availability', 0) == 1 ? 'checked' : '' }}>
